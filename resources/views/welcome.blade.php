...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 flex flex-col justify-center">
    <div class="max-w-3xl mx-auto py-4 w-full">
        ...
        <div class="flex flex-row flex-wrap gap-4 justify-center items-stretch">
            <a href="{{ route('patient.dashboard') }}" class="bg-white p-4 rounded-2xl shadow-lg hover:shadow-xl transition border border-blue-100 flex flex-col items-center w-56">
            ...
            <a href="{{ route('hospital.dashboard') }}" class="bg-white p-4 rounded-2xl shadow-lg hover:shadow-xl transition border border-green-100 flex flex-col items-center w-56">
            ...
            <a href="{{ route('patient.emergency.show') }}" class="bg-red-50 p-4 rounded-2xl shadow-lg hover:shadow-xl transition border border-red-100 flex flex-col items-center w-56">
