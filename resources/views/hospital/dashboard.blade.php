...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 flex items-center justify-center px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-2xl mx-auto py-12">
        ...
        <div class="flex flex-row flex-wrap justify-center items-center gap-8">
            <a href="{{ route('doctor.profile') }}" class="flex flex-row items-center bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-xl px-6 py-4 shadow-lg transition w-64">
            ...
            <a href="{{ route('hospital.admin-dashboard') }}" class="flex flex-row items-center bg-green-50 hover:bg-green-100 border border-green-200 rounded-xl px-6 py-4 shadow-lg transition w-64">
