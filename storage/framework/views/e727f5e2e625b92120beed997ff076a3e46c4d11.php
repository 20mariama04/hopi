...
<?php $__env->startSection('title', 'Détails de l\'hôpital'); ?>
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-8">
        <div class="w-full h-48 sm:h-64 relative">
            <img src="<?php echo e(asset('images/hospital-cover.jpg')); ?>" alt="Hôpital" class="w-full h-full object-cover">
        </div>
    ...
    <div class="mt-8">
        ...
        <section class="mb-8">
            <div class="flex items-center gap-2 mb-4">
                <?php if($specialty['icon'] === 'heart'): ?>
                <svg class="h-6 w-6 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 016.364 0L12 7.636l1.318-1.318a4.5 4.5 0 116.364 6.364L12 21.364l-7.682-7.682a4.5 4.5 0 010-6.364z"/>
                </svg>
                <?php elseif($specialty['icon'] === 'baby'): ?>
                ...
                <?php endif; ?>
                <h2 class="text-lg font-semibold text-blue-900"><?php echo e($specialty['name']); ?></h2>
            </div>
            <div class="space-y-4">
                ...
                <div class="bg-white shadow rounded-lg p-4 flex flex-col sm:flex-row items-center gap-4 relative">
                    ...
                    <div class="absolute left-4 top-4 flex items-center z-10 bg-white bg-opacity-80 px-2 py-1 rounded shadow-sm">
                        ...
                        <?php if($halfStar): ?>
                            <svg class="h-4 w-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                                <defs>
                                    <linearGradient id="half-grad-<?php echo e($loop->parent->index); ?>-<?php echo e($loop->index); ?>">
                                        <stop offset="50%" stop-color="currentColor"/>
                                        <stop offset="50%" stop-color="transparent"/>
                                    </linearGradient>
                                </defs>
                                <path fill="url(#half-grad-<?php echo e($loop->parent->index); ?>-<?php echo e($loop->index); ?>)" d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                            </svg>
                        <?php endif; ?>
                    ...
                    <div class="flex-1 w-full">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                <span class="block font-semibold text-blue-900 text-lg"><?php echo e($doctor['name']); ?></span>
                                <span class="block text-blue-600 text-sm"><?php echo e($specialty['name']); ?></span>
                            </div>
                            <!-- Availability -->
                        ...
                        <div class="mt-2 flex flex-col sm:flex-row sm:items-center sm:gap-4 text-gray-600 text-sm">
                            <span>
                                ...
                                <?php echo e($doctor['experience'] ?? '10+'); ?> ans en <?php echo e($specialty['name']); ?>
                    ...
                    <button class="w-full sm:w-auto bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors text-sm mt-4 sm:mt-0"
                        <?php if(!$doctor['available']): ?> disabled class="opacity-50 cursor-not-allowed" <?php endif; ?>>
                        Prendre rendez-vous
                    </button>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP 1030 G3\Documents\project2025\hospital\resources\views/patient/hospital-details.blade.php ENDPATH**/ ?>