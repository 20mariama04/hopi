...
<?php $__env->startSection('title', "Aide d'Urgence"); ?>
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-white py-8 flex items-center justify-center">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
        ...
        <form id="desc-section" action="<?php echo e(route('emergency.describe')); ?>" method="POST" class="w-full max-w-2xl bg-white rounded-2xl shadow p-12 flex flex-col items-center justify-center" style="display: flex;">
            <?php echo csrf_field(); ?>
        ...
        <div id="evaluation-section" class="w-full max-w-md bg-white rounded-2xl shadow p-6 flex flex-col items-center justify-center relative" style="display: none;">
            ...
            <!-- Arrow Button -->
            <a href="<?php echo e(route('hospital.emergency-requests')); ?>" class="absolute top-4 right-4 bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-full shadow-lg">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP 1030 G3\Documents\project2025\hospital\resources\views/aidedurgence/emergency.blade.php ENDPATH**/ ?>