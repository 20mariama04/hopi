...
<?php $__env->startSection('title', 'SAMA SANTÉ - DOCTOR DASHBOARD'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-white py-10">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="mb-4 flex justify-between">
            ...
            <!-- Right Arrow Button -->
            <button onclick="window.location.href='<?php echo e(route('emergency-confirmation')); ?>'" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-full transition shadow-md">
                ➡️
            </button>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <button class="mt-4 text-blue-600 hover:text-blue-800" onclick="window.location.href='<?php echo e(route('full-records-page')); ?>'">[📂 Voir tous les dossiers]</button>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP 1030 G3\Documents\project2025\hospital\resources\views/doctor/dashboard.blade.php ENDPATH**/ ?>