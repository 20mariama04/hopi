...
<?php $__env->startSection('title', 'Choisissez votre rôle'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto py-16 px-4">
    <h1 class="text-2xl font-bold text-center mb-10">Vous êtes&nbsp;?</h1>
    <div class="flex flex-row justify-center items-center gap-8">
        <a href="<?php echo e(route('doctor.profile')); ?>" class="flex flex-row items-center bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg p-8 shadow transition w-72">
        ...
        <a href="<?php echo e(route('hospital.profile')); ?>" class="flex flex-row items-center bg-green-50 hover:bg-green-100 border border-green-200 rounded-lg p-8 shadow transition w-72">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP 1030 G3\Documents\project2025\hospital\resources\views/hospital/role-selection.blade.php ENDPATH**/ ?>