...
<?php $__env->startSection('title', 'Administration - Tableau de Bord'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-white py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 gap-6 mb-10">
            <a href="<?php echo e(route('hospital.availability')); ?>" class="bg-white border border-blue-100 rounded-xl p-6 flex flex-col items-center shadow hover:shadow-lg transition group">
            ...
            <a href="<?php echo e(route('hospital.emergency-requests')); ?>" class="bg-white border border-red-100 rounded-xl p-6 flex flex-col items-center shadow hover:shadow-lg transition group">
                <span class="text-3xl mb-2">🚨</span>
            ...
            <a href="<?php echo e(route('hospital.appointments')); ?>" class="bg-white border border-green-100 rounded-xl p-6 flex flex-col items-center shadow hover:shadow-lg transition group">
                <span class="text-3xl mb-2">📅</span>
            ...
            <a href="<?php echo e(route('hospital.notifications')); ?>" class="bg-white border border-gray-200 rounded-xl p-6 flex flex-col items-center shadow hover:shadow-lg transition group">
                <span class="text-3xl mb-2">📢</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP 1030 G3\Documents\project2025\hospital\resources\views/hospital/admin-dashboard.blade.php ENDPATH**/ ?>