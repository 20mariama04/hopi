...
<?php $__env->startSection('title', 'Tableau de bord patient'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-row flex-wrap gap-8 justify-center items-center mb-8">
        <a href="<?php echo e(route('patient.find-hospital')); ?>" class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition border border-blue-100 flex flex-col items-center w-72">
        ...
        <a href="<?php echo e(route('patient.appointments')); ?>" class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition border border-green-100 flex flex-col items-center w-72">
        ...
        <a href="<?php echo e(route('patient.medical-records')); ?>" class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition border border-purple-100 flex flex-col items-center w-72">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP 1030 G3\Documents\project2025\hospital\resources\views/patient/dashboard.blade.php ENDPATH**/ ?>