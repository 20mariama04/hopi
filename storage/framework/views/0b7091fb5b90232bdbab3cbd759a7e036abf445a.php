...
<?php $__env->startSection('title', 'Trouver un hôpital'); ?>
...
<div class="flex flex-row flex-wrap gap-6">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-md transition-shadow w-full md:w-1/2 lg:w-1/3">
        ...
        <div class="bg-gray-50 px-4 py-4 flex justify-between border-t">
            ...
            <a href="<?php echo e(route('patient.hospital-details', ['id' => 1])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP 1030 G3\Documents\project2025\hospital\resources\views/patient/find-hospital.blade.php ENDPATH**/ ?>